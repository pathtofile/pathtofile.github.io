...
# Results - UacScan
I created a project called [ETW Watcher](https://github.com/pathtofile/etw_watcher/), which demonstrates using the managed Github Actions runner to provide daily updates to the list of ETW Providers, if there were any.
