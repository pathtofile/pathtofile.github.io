...
# Results - UacScan
I created a project called [ETW Watcher](git@github.com:pathtofile/etw_watcher.git), which demonstrates using the managed Github Actions runner to provide daily updates to the list of ETW Providers, if there were any.
...
Requests
This new `UacScan` Provider looks to have a wealth of information for both defenders looking to track UAC Requests,
and bug hunters looking for auto-elevating COM Objects and executables to exploit.
